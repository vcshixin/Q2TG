...
export declare class Client extends BaseClient {
     ...
     */
    readonly pickMember: (gid: number, uin: number, strict?: boolean | undefined) => Member;
    /**
     * 创建一个用户对象
     * @param uin 用户的账号
     * @returns 一个`User`对象
    ...
    /** 获取用户资料卡信息 */
    getProfile(uin: number): Promise<import("./common").UserProfile>;
    /** 设置头像 */
    ...
    getMsg(message_id: string): Promise<import("./message").PrivateMessage | import("./message").GroupMessage | undefined>;
    /** @cqhttp use {@link User.getChatHistory} or {@link Group.getChatHistory} */

...
export declare class Group extends Discuss {
     ...
     */
    pickMember(uin: number, strict?: boolean): import("./member").Member;
    /**
     * 获取群头像url
     ...
     * @param uin 好友账号
     */
    invite(uin: number): Promise<boolean>;
    /** 打卡 */
    sign(): Promise<{
        result: number;
    }>;
     ...
     */
    setReaction(seq: number, id: string, type?: number): Promise<any>;
    /**
     ...
     * @param type 表情类型 EmojiType
     */
    delReaction(seq: number, id: string, type?: number): Promise<any>;
}
export {};

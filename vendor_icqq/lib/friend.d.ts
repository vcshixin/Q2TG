...
export declare class User extends Contactable {
    ...
    get user_id(): number;
    get uid(): string;
    static as(this: Client, uin: number): User;
    protected constructor(c: Client, uin: number, _uid: string);
    /** 返回作为好友的实例 */
...
export declare class Friend extends User {
    ...
    protected constructor(c: Client, uin: number, _info?: FriendInfo | undefined);
    /** 设置备注 */

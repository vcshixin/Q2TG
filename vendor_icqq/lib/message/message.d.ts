...
/** @cqhttp 生成私聊消息id */
export declare function genDmMessageId(uin: number, seq: number, rand: number, time: number, flag?: number): string;
/** @cqhttp 解析私聊消息id */
...
/** @cqhttp 生成群消息id */
export declare function genGroupMessageId(gid: number, uin: number, seq: number, rand: number, time: number, pktnum?: number): string;
/** @cqhttp 解析群消息id */
...
export declare abstract class Message implements Quotable, Forwardable {
    ...
    static deserialize(serialized: Buffer, uin?: number, nt?: boolean): PrivateMessage | GroupMessage | DiscussMessage;
    /** 组合分片消息(通常仅内部使用) */
...
export declare class PrivateMessage extends Message {
    ...
    constructor(proto: pb.Proto, uin?: number, nt?: boolean);
}
/** 一条群消息 */
export declare class GroupMessage extends Message {
    ...
    constructor(proto: pb.Proto, nt?: boolean);
}
/** 一条讨论组消息 */
